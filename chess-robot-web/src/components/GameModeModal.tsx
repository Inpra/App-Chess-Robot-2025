        ...
        <div className="game-modal-overlay" onClick={onClose}>
            <div className="game-modal-container" onClick={(e) => e.stopPropagation()}>
                ...
                <div className="game-modal-header">
                    <h2 className="game-modal-title">Select Game Mode</h2>
                ...
                <div className="game-modal-content">
                    <p className="game-modal-subtitle">Choose a difficulty level to start the match.</p>
                            ...
                            return (
                                <div
                                    ...
                                    onClick={() => {
                                        ...
                                        console.log('Starting game with difficulty:', level.id);
                                        onClose();
                                    }}
                                >
